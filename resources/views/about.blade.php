...
<div class="container mx-auto px-4 flex flex-col lg:flex-row lg:px-0 gap-8 justify-center items-center mt-10 mb-14 lg:max-h-screen">
  <div class="order-2 max-w-[600px] lg:pl-8">
    ...
    <div class="pt-6">
      ...
      <p class="mb-4 font-regular">Lia focuses on redefining beauty and is constantly furthering her education in all aesthetic and constantly raising the standard in medical services to deliver clinically effective skin treatments. Through her hard work she has made an imprint on the industry and Maya has an exemplary reputation.</p>
      <p class="mb-4 font-regular">Passionate in her role as MedSpa Owner & Director, she is highly involved in overseeing daily operations and committed to bridging the gap between medically based aesthetics and the tranquility of a spa.</p>
      <p class="mb-4 font-regular">Lia and her team selectively curate a selection of premium products and leading edge technologies that are both safe and proven successful in results.</p>
    </div>
  </div>
  <div class="order-1">
    <img src="/img/about-lia.jpeg" srcset="/img/about-lia.jpeg 500w, /img/about-lia.jpeg 800w, /img/about-lia.jpeg 996w" sizes="(max-width: 479px) 91vw, (max-width: 767px) 88vw, 497px" alt="Lia Naccarato" class="overlap-section-image max-w-full h-auto" />
  </div>
</div>
...
<div class="container mx-auto px-4 lg:px-0 flex flex-col lg:flex-row gap-8 justify-center items-center mb-24 lg:max-h-screen">
