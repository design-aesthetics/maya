<!-- <a href="/blog" class="blog-post max-w-[90%] scale-90 overflow-hidden border border-slate-200 md:max-w-[400px] md:scale-100">
            <div class="featured-image w-full h-52 bg-slate-200">
                @if($featured_image)
                <img src="{{ asset($featured_image) }}" alt="featured_blog_image" class="w-full h-full object-cover">
                @endif
            </div>
...
<a href="/blog" class="blog-post max-w-[90%] md:max-w-[400px] scale-90 md:scale-100 overflow-hidden border border-slate-200">
    <div class="featured-image w-full h-52 bg-slate-200">
        @if($featured_image)
