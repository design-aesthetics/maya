...
<nav id="navbar" class="max-w-7xl px-8 mx-auto">
    ...
    <div id="mega-menu-full-dropdown" class="hidden mt-1 border-gray-200 bg-gray-50 md:bg-white border-y z-50 lg:pb-14">
        <div class="grid grid-cols-4 max-w-screen-xl px-0 py-5 justify-between mx-auto text-gray-900 lg:gap-y-10 h-full lg:overflow-y lg:pb-10">
            {{-- <div class="w-full flex justify-between basis-1/6"> --}}
